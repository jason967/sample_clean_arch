...
mixin _$MenuDto {
  ...
  dynamic get tabId => throw _privateConstructorUsedError;
...
abstract class $MenuDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic title, dynamic tabId});
}
...
class __$$_MenuDtoCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$_MenuDto(
      ...
      tabId: freezed == tabId ? _value.tabId! : tabId,
    ));
  }
}
...
/// @nodoc
@JsonSerializable()
class _$_MenuDto with DiagnosticableTreeMixin implements _MenuDto {
  const _$_MenuDto({this.title = '', this.tabId = -1});
...
abstract class _MenuDto implements MenuDto {
  const factory _MenuDto({final dynamic title, final dynamic tabId}) =
      _$_MenuDto;
